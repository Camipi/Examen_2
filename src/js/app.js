		  ...
		  if (input.files && input.files[0]) {
		    ...
		    reader.onload = function(e) {
		      ...
		      //Agrega un nuevo tweet al tope del listado que se va creando
				...
				+ '<div class="col-md-2 content__tweet-picture">' 
				+ 	'<img class="img-fluid btnDelete" src="'+ e.target.result +'" alt="imagen de perfil">' 
				+ '</div>'
				+ '<div class="col-md-6 content__tweet-name">' 
				+ 	'<h5>' + textName + '</h5><h6>' + textNickname + '</h6></div>'
				+ '<div class="col-md-3 content__tweet-time">' 
				+ 	'<p>15 min</p>' 
				+ '</div>' 
				+ '<div class="col-md-1 content_tweet-delete">' 
				+ 	'<button class="btnDelete"><i class="fas fa-times"></i></button>' + '</div>'
				+ '<div class="col-md-12 content__tweet-text">' 
				+ 	'<p>' + textTweet + '</p>'
				+ '</div>'
				+ '<div class="col-md-12 content__tweet-line">' + '</div>'
				+ '<div class="row col-md-12 content__tweet-count justify-content-center">' 
				+ 	'<p><a href="#"><i class="col-md-3 far fa-comment"></i></a></p>'
				+ 	'<p><a href="#"><i class="col-md-3 fas fa-retweet"></i></a></p>'
				+ 	'<p><i class="col-3 heart far fa-heart"></i><span id="likes_' + contador + '">0</span></p>'
				+ 	'<p><a href="#"><i class="col-md-3-3 far fa-envelope"></i></a></p>'
				+ '</div>' 
				+ '</div>');
